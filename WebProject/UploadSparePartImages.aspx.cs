...
{
    public partial class UploadSparePartImages : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.RequestType == "POST")
            {
                ...
                Response.Write(UploadSparePartImage());
                Response.End();
            }
        }

        private static string UploadSparePartImage()
        {
            string firstError = "";
            string uploadPath = "~/UploadSparePartImage/";
            try
            {
        ...
        private static string SaveFileToDb(string fileName, string FileSize)
        {
            ...
            return DBHelper.InvokeSP("FX_UPD_SparePartImageUpload_SP", PD).ToString();
        ...
        static string GetUploadedFileList()
        {
            ...
            DataSet ds = DBHelper.GetDataTableProc("FX_UPD_SparePartImageUpload_SP", PD);
