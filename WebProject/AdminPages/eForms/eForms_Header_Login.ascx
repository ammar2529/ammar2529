...
<table cellspacing="0" cellpadding="0" width="100%" border="0">
    <tbody>
        <tr>
            ...
            <td width="35%"></td>
            <td nowrap="nowrap" class="header-cell">
                <div class="tmp_rtxtb text-align-positive" style="color: #ffffff;">
                    User ID:
                </div>
            </td>
            <td class="input-container">
                <div style="width: 150px;">
                    <input type="text" class="text required" tabindex="1" blurvalidate="false"
                        requirederr=" *" argumentid="UserName" groupid="UserLogin" value="" />
                </div>
            </td>
            <td>
            ...
            <td class="input-container">
                <div style="width: 150px;">
                    <input type="password" value="" class="text required" tabindex="2" argumentid="UserPassword"
                        groupid="UserLogin" blurvalidate="false" requirederr="*" />
                </div>
            </td>
            <td>
...
<div id="content">
    <table cellspacing="0" cellpadding="0" width="100%" border="0" style="padding-left: 20px; padding-right: 20px; padding-bottom: 10px; padding-top: 5px;">
        <tbody>
            <tr>
                <td width="100%" style="padding-top:15px;padding-bottom:10px;padding-right:50px" valign="top">
                    ...
                    <br /><br />
                    In the fast-moving and demanding world in which we live and work, once in a rare while a company 
                    comes along that actually delivers more than it promises, exceeding the customers needs, beyond their
                    expectations and imagination – A company that is dynamic, innovative and yet completely dependable. 
                    A company that raises the bar...
                    <br /><br />
                    We depend on our technically advanced next generation infrastructure to deliver best in class customer-aware 
                    and lifestyle-enhancing products and services that anticipate customer's needs. We understand that customers 
                    are on-the-go, busy and mobile and expect frictionless and seamless services. By deeply understanding the needs
                    of customers we deliver the right products and services at the right time – helping customers simplify their lives,
                    enabling them to transact their businesses and lives easily and ensuring a WOW user-experience from start to finish.
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0" style="padding-left: 20px; padding-right: 20px; padding-bottom: 10px; padding-top: 5px;">
        <tbody>
            <tr>
                ...
                <td class="text-align-positive" style="color: #ffffff; padding: 5px 10px 5px 10px;">
                    <b><a style="text-decoration: none; color: #ffffff;" showwidget="frmHome" href="javascript:void(0);">Home</a></b>
                </td>
                <td width="35%"></td>
                <td nowrap="nowrap" class="header-cell">
                    <div class="tmp_rtxtb text-align-positive" style="color: #ffffff;">
