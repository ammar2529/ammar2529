...
ALTER VIEW [dbo].[VW_iRental_CarsForSale_Available]
AS
SELECT        dbo.iRental_CarsForSale.ChassisNo, dbo.iRental_CarsForSale.RecId, dbo.iRental_CarsForSale.RecCode, dbo.iRental_CarsForSale.CarFor, dbo.iRental_CarsForSale.CarNumber, dbo.iRental_CarsForSale.BrandId, 
                         ...
                         dbo.iRental_SalesCarPrice.Price + dbo.iRental_SalesCarPrice.AdditionalAmount - dbo.iRental_SalesCarPrice.Discount AS TotalAmount, dbo.iRental_SalesCarPrice.Price
