...
<head>
    ...
    <script src="AsyncWidgets/Scripts/jquery.alphanumeric.js"></script>
    <script src="AsyncWidgets/Scripts/WidgetBase.js"></script>
    <script src="AsyncWidgets/Scripts/jquery.jclock.js"></script>
    <script src="AsyncWidgets/Scripts/jQueryUI/jquery-ui.js"></script>
    <script src="AsyncDashboards/FusionCharts/FusionCharts.js"></script>
    <script src="Scripts/Common/SessionExpired.js"></script>
</head>
<body>
    <form id="form1" runat="server">
        <div>
<%--            <uc5:SalesContracts runat="server" ID="SaleContracts" />--%>
    ...
    <script>
        $(document).ready(function () {
            setTimeout(function () {
                AsyncWidgets.get("conRentalContracts").show();
            }, 500);
        });
    </script>
</body>
