...
SELECT        dbo.iRental_SalesContracts.RecId, dbo.iRental_SalesContracts.RecCode, dbo.iRental_SalesContracts.CustomerRecCode, dbo.iRental_SalesContracts.ChassisNo, dbo.iRental_SalesContracts.CarRateType,       
                         ...
                         dbo.iRental_SalesContracts.ContractExpiryDay, dbo.iRental_SalesContracts.ReservationExpireTime, dbo.iRental_SalesContracts.ReservationWeekDays,ContractDate,ContractWeekDay,ContractTime,  
       DeliveryDate,DeliveryWeekDays,DeliveryTime,EngineWarranty,EnginYearsWarranty,GearWarranty,GearYearsWarranty,CarWarranty,CarYearsWarranty,PaymenteMethod, FinanceCompany,CarOwnerName,CarReplacement, 
       dbo.iRental_SalesContracts.FileGuid,       
                         dbo.iRental_SalesContracts.AdditionalAmount, dbo.iRental_SalesContracts.Discount, dbo.iRental_SalesContracts.TotalAmount      
