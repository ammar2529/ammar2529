...
ALTER VIEW [dbo].[VW_iRental_CarsForSale]
AS
SELECT        ChassisNo, RecId, RecCode, CarFor, CarNumber, BrandId, ModelId, YearId, ColorId, TypeId, CurrentMileage AS InsuranceCompanyId, CarLocationId AS InsuranceExpiry, CarStatusId AS InsurancePolicyNo, 
