...
*/
ALTER  Procedure [dbo].[UPD_iRental_SalesContracts_Payments_SP]
	@__UserId varchar(50),
	@__IP varchar(50),
	@RecId int,
...
Begin Tran Ins
	...
	select @OutLocationId = isnull(sum(OutLocationId),0) from iRental_SalesContracts where RecId = @ParentRecId
