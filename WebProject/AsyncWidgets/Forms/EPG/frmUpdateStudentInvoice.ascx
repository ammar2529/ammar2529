<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmUpdateStudentInvoice.ascx.cs" Inherits="WebProject.AsyncWidgets.Forms.EPG.frmUpdateStudentInvoice" %>
                    ...
                    <table class="FormTable" style=" width: 100%" cellspacing="1" >
                      ...
                      <tr>
                            ...
                            class="PWCTextBox required" requirederr="&amp;nbsp;*" alt="" />
                                    <input type="text" groupid="StudentInvoice" argumentid="FormId" style="width: 150px ;display:none"
                         ...
                         <textarea  groupid="StudentInvoice" argumentid="Notes"  style="width:450px;display:"" 
                            ...
                            <td colspan="4" style="text-align:center;">
                                  <input type="button" conf="{ActorId:'DataHelper',ActionId:'DataAction',Command:'EPG_UPD_StudentInvoice'}" class="DataAction PWCButton" value="  Update  ">
                                 <input type="button"  conf="{ActionId:'HideForm'}" class="PWCButton WidgetAction"  value="  Cancel  ">
                            </td>
                        </tr>
