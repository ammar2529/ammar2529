...
{
    public partial class UploadFileForCarServiceDetails : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            if (Request.RequestType == "POST")
            {
                ...
                Response.Write(UploadFilesForJC());
                Response.End();
            }
        ...
        public static string UploadFilesForJC()
        {
            string firstError = "";
            string uploadPath = "~/UploadsFilesForCarServiceDetails/";
            try
            {
        ...
        private static string SaveFileToDb(string fileName, string FileSize,string UserId)
        {
            ...
            return DBHelper.InvokeSP("FX_UPD_FileUploadForCarServiceDetails_SP", PD).ToString();
        ...
        static string GetUploadedFileList()
        {
            ...
            DataSet ds = DBHelper.GetDataTableProc("FX_UPD_FileUploadForCarServiceDetails_SP", PD);
