<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DummyMaster.master" AutoEventWireup="true" CodeBehind="iFrameGridReports.aspx.cs" Inherits="WebProject.ReportsEngine.iFrameGridReports" %>
                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td class="w-head-text">
                                                                                                            <asp:Label ID="Label4" runat="server" CssClass="PWCSubTitleHeader" Text="Search"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
