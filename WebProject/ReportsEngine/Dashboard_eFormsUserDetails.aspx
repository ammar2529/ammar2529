<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DummyMaster.master" AutoEventWireup="true" CodeBehind="Dashboard_eFormsUserDetails.aspx.cs" Inherits="WebProject.ReportsEngine.Dashboard_eFormsUserDetails" %>
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" align="left" style="float: none">
        <tr>
          ...
          <tr> 
            ...
            <td width="130" class="tabselected"><div align="center"><a href="Dashboard_eFormsUserDetails.aspx">eForms User Details</a></div></td>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td >
                                                                                                                        ...
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                <td valign="top" style="padding-right: 5px; padding-left: 5px" align="center" width="75%">
                                                                                                                                   
                                                                                                                                                     <%=LoadChart_S_1()%>
                                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="500" style="display: none">
                                                                                                                                        <tr>
                                                                                                                                    ...
                                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" width="500" style="display: none">
                                                                                                                                        ...
                                                                                                                                        <tr style="height: 27px">
                                                                                                                                            <td id="Link1" onclick="Home()" style="background-image: url(../../App_Themes/Blue/Images/ReportViewer/ReportLinkBack.jpg);
                                                                                                                                                width: 157px; background-repeat: no-repeat; vertical-align: middle; cursor: hand; text-align: center; font-family:Sans-Serif; font-weight:bold; font-size:11px;">
                                                                                                                                                Home</td>
                                                                                                                                            <td>
                                                                                                                                            </td>
                                                                                                                                            <td id="Td1" onclick="ProjectDetails()" style="background-image: url(../../App_Themes/Blue/Images/ReportViewer/ReportLinkBack.jpg);
                                                                                                                                                width: 157px; background-repeat: no-repeat; vertical-align: middle; cursor: hand; text-align: center; font-family:Verdana; font-size:11px; font-weight:bold;">
                                                                                                                                                Project Details</td>
                                                                                                                                            <td>
                                                                                                                                            </td>
                                                                                                                                            <td id="Td2" onclick="eFormsUserDetails()" style="background-image: url(../../App_Themes/Blue/Images/ReportViewer/ReportLinkBack.jpg);
                                                                                                                                                width: 157px; background-repeat: no-repeat; vertical-align: middle; cursor: hand; text-align: center; font-family:Verdana; font-size:11px; font-weight:bold;">
                                                                                                                                                eForms User Details</td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td colspan="5">
                                                                                                                                                <img height="4" src="../../App_Themes/Blue/Images/spacer.gif" /></td>
                                                                                                                                    ...
                                                                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                        <tr>
                                                                                                                                            <td style="background-color: #eeeeee;">
                                                                                                                                                <img src="../../App_Themes/Blue/Images/spacer.gif" width="1" height="325" />
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                </td>
