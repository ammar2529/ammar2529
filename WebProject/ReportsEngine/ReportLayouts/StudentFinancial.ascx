<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StudentFinancial.ascx.cs" Inherits="WebProject.ReportsEngine.ReportLayouts.StudentFinancial" %>
        ...
        <td colspan="2">
            <table id="SimpleLayout" runat="server" border="0" width="100%" height="100%" cellpadding="0"
                ...
                <tr valign="bottom" align="center" style="height: 10%;">
                    <td style="background-color: #E1E9EC" >
                    </td>
                    <td style="background-color: #E1E9EC" >
                    </td>
                </tr>
                ...
                <tr valign="bottom" align="center" style="height: 10%">
                    ...
                    <td style="background-color: #F9F9F9" colspan="2" ></td>                                 
                </tr>                                                            
                <tr valign="bottom" align="center" style="height: 10%">
                    <td style="background-color: #E1E9EC" colspan="2" >
                    </td>   
