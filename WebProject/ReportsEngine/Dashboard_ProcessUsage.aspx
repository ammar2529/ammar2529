<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DummyMaster.master" AutoEventWireup="true" CodeBehind="Dashboard_ProcessUsage.aspx.cs" Inherits="WebProject.ReportsEngine.Dashboard_ProcessUsage1" %>
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" align="left" style="float: none">
        <tr>
          ...
          <tr>
            ...
            <td width="130" class="tabselected"><div align="center"><a href="Dashboard_ProcessUsage.aspx">Process Usage</a></div></td>
            <td width="130" class="tab"><div align="center"><a href="Dashboard_ManagementProjects.aspx">Management Projects</a></div></td>
            <td width="130" class="tab" style="DISPLAY :none"><div align="center"><a href="Dashboard_eFormsUserDetails.aspx">eForms User Details</a></div></td>
            ...
            <td align="center">&nbsp;<asp:Label ID="Label1" runat="server" Text="Selected Business Group:" CssClass="PWCLabel" Visible="False"></asp:Label>
                <asp:Label ID="lblBusinessGroup" runat="server" Text="N/A" CssClass="PWCLabelValue" Visible="False"></asp:Label>
                &nbsp; &nbsp;
                <asp:Label ID="Label3" runat="server" Text="Function:" CssClass="PWCLabel" Visible="False"></asp:Label>
                <asp:Label ID="lblFunction"
                    runat="server" CssClass="PWCLabelValue" Visible="False">N/A</asp:Label></td>
          </tr>
        </table>
                                                                                        </td>
                                                                                    </tr>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td >
                                                                                                                        ...
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                            <tr>
                                                                                                                                <td valign="top" style="padding-right: 5px; padding-left: 5px" align="center">
                                                                                                                                    ...
                                                                                                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                                                                                                        <tr>
                                                                                                                                            <td style="background-color: #eeeeee;">
                                                                                                                                                <img src="../../App_Themes/Blue/Images/spacer.gif" width="4" height="275" />
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                    </table>
                                                                                                                                </td>
                                                                                                                                <td valign="top" style="padding-right: 5px; padding-left: 5px" align="center" width="100%">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td colspan="3" style="padding-left:10px;padding-right:10px"  height="4" >
                                                                                                                                <hr style="border-top: #eeeeee 1px solid; border-left-width: 1px; border-left-color: black; border-bottom-width: 1px; border-bottom-color: black; height: 3px; border-right-width: 1px; border-right-color: black"  />
                                                                                                          
                                                                                                                                    <asp:RadioButtonList ID="rblSelectedGraph" runat="server" CssClass="PWCLabelValue"
                                                                                                                                        ForeColor="Black" RepeatDirection="Horizontal" RepeatLayout="Flow" Visible="False">
                                                                                                                                        <asp:ListItem Selected="True" Value="0">Process Usage</asp:ListItem>
                                                                                                                                        <asp:ListItem Value="1">Status Report</asp:ListItem>
                                                                                                                                        <asp:ListItem Value="2">Feedback</asp:ListItem>
                                                                                                                                    </asp:RadioButtonList>
                                                                                                                                <hr style="border-top: #eeeeee 1px solid; border-left-width: 1px; border-left-color: black; border-bottom-width: 1px; border-bottom-color: black; height: 3px; border-right-width: 1px; border-right-color: black; display: none;"  />
