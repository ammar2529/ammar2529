...
/// <summary>
/// Summary description for XmlHttpPanelWebService
/// </summary>
[ScriptService]
public class XmlHttpPanelWebService : System.Web.Services.WebService {

    public XmlHttpPanelWebService () {
...
WHERE     (SearchPanelID = '{0}') AND (FieldID = '{1}')  AND (FieldProperty = 'LookupQuery') ", SearchPanelId, ChildDDLId );
