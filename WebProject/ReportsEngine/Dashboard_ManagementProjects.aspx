<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DummyMaster.master" AutoEventWireup="true" CodeBehind="Dashboard_ManagementProjects.aspx.cs" Inherits="WebProject.ReportsEngine.Dashboard_ManagementProjects" %>
    ...
    <table id="Table1" cellspacing="0" cellpadding="0" width="100%" align="left" style="float: none">
        <tr>
          ...
          <tr>
            ...
            <td width="130" class="tabselected"><div align="center"><a href="Dashboard_ManagementProjects.aspx">Management Projects</a></div></td>
                                                                                                        ...
                                                                                                        <td >
                                                                                                                        ...
                                                                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                     ...
                                                                                                                                     <td valign="top" style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px; padding-top: 5px;" align="center" width="50%">
                                                                                                                                 <%=( LoadChart_S_2 )%>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center" style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px;
                                                                                                                                    padding-top: 5px" valign="top" width="50%">
                                                                                                                                    <asp:Label ID="Label1" runat="server" CssClass="PWCLabelValue" Text="Last 2 Week's Project Status" ForeColor="Black"></asp:Label><br><br>
                                                                                                                                    <%=LoadChart_S_8()%>
                                                                                                                                    </td>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td align="center" style="padding-right: 5px; padding-left: 5px; padding-bottom: 5px;
                                                                                                                                    padding-top: 5px" valign="top" width="100%">
                                                                                                                                    
                                                                                                                                                                                                                                       <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                                                                                             <tr>
                                                                                                                                                 <td style="padding-right: 5px; padding-left: 5px; width: 30%">
                                                                                                                                                 <%=LoadChart_S_5()%>
                                                                                                                                                 </td>
                                                                                                                                                 <td style="padding-right: 5px; padding-left: 5px; width: 30%">
                                                                                                                                                 <%=LoadChart_S_6()%>
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td align="center" style="padding-right: 5px; padding-left: 5px" valign="top" colspan="3">
                                                                                                                                <%=LoadChart_S_1()%>
                                                                                                                                </td>
                                                                                                                            </tr>
