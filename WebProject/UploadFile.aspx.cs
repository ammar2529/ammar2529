...
namespace WebProject
{
    public partial class UploadFile : System.Web.UI.Page
    {
        ...
        {
            string firstError = "";
            string uploadPath = @"E:\Uploads"; //physical path on server to save files
            try
            {
        ...
        private static string SaveFileToDb(string fileName, string FileSize, string UserID)
        {
            ...
            PD.Add("FileSize", new QueryParameter(FileSize));
        ...
        static ParamDictionary<string, AsyncWidgets.DAL.QueryParameter> GetParamsFromPost()
        {
            ...
            var PD = new ParamDictionary<string, AsyncWidgets.DAL.QueryParameter>("UploadFile2", "");
        ...
        {
            var PD = GetParamsFromPost();
            PD.Add("DBAction", new QueryParameter("GetUploadedFiles"));
