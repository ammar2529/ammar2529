...
<AW:Container ID="conBeneficiary" Hidden="true" Caption="Beneficiary Management" runat="server">
              <Childern>
                <AW:Form ID="frmBeneficiaryManagement_ShUc" runat="server" Hidden="true" LoadOnInit="false" ShowOnLoad="true" DataSource="SEL_iRental_Customers" AsyncForm="~/Pages/eForms/iRental/CustomerDetails_ShUc.ascx" >
                <WidgetConfig>
                <script>
                    cf = {
                        header: {
            ...
            GridHeadText="Beneficiary Management"  GridButtons="{\'delete\':{conf:{Command:\'UPD_iRental_Customers\',KeysCol:\'RecId\'}}}">
            ...
            <AW:Form ID="frmBeneficiaryManagement" Hidden="true" LoadOnInit="false" ShowOnLoad="true" runat="server" AsyncForm="~/Pages/eForms/Accounts/BeneficiaryManagement_FrUc.ascx" >
                            <WidgetConfig>
                <script>
                    cf = {
