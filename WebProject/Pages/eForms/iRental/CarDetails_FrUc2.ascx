...
<div class="">
    <form>
        ...
        <div class="row mt-2 justify-content-md-center">
            <div class="col-12 col-sm-12 col-lg-6">
                <div class="form-floating">
                    <select class="form-select form-select-sm dropdownlist required" id="BrandId" groupid="CarsForm" 
...
<div class="row mt-2 justify-content-md-center">
    ...
    <div class="col-6 col-sm-6 col-lg-2 mt-3">
        <span id="ContractNo" class="form-text text-danger" groupid="CarsForm" argumentid="ContractNo">
        </span>
    </div>
</div>
        ...
        <div class="row mt-2 justify-content-md-center mb-2">
            <div class="col-12 col-sm-6 col-lg-2">
                <button type="button" class="btn btn-primary w-100 DataAction" 
                        conf="{ActorId:'DataHelper', ActionId:'DataAction', Command:'UPD_iRental_Cars', HideOnSuccess:true}">Save</button>
            </div>
            <div class="col-12 col-sm-6 col-lg-2">
