...
<table cellspacing="2" cellpadding="0" width="100%" border="0" class="w-form-table">
  ...
  <tr>
    ...
    <td width="100%">
      <input type="text" style="text-align:center;width:150px;"  maxlength="50" class="text required validateunique" primarykey="ChassisNo"
          ...
          uniquefound="{en:' Duplicate Chassis Number...',color:'red'}" groupid="CarsForm"  argumentid="ChassisNo" />
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
      ...
      <div><input type="text" style="text-align:center;width:150px; font-weight:bold;color:red"  maxlength="10" class="text  validateunique" primarykey="ChassisNo"
                  storeid="iRental_CarsForSale" uniquenotfound="{en:' Car Number is valid...',color:'green'}" 
                  uniquefound="{en:' Duplicate Car Number...',color:'red'}" groupid="CarsForm"  argumentid="CarNumber" /></div>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td >
    <input type="text" style="display:none" groupid="CarsForm"  argumentid="action" value="new" class="noautoreset" />
