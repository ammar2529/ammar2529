                    ...
                    Use the form below to update the details, fields marked with an asterisk (*) are mandatory
                     ...
                     <tr>
                            ...
                            <td>
                                    ...
                                    <div><input type="text" style="text-align:center;width:150px; font-weight:bold;color:red"  maxlength="10" class="text required CommonDisable"
                                    groupid="RentalContractsForm"  argumentid="CarNumber" /></div>
                            </td> 
                            <td class="ftitle">
                        ...
                        <tr class="OnLoadHideCarCust">
                            ...
                            <td>
                             <div style="float:left;width:135px" class="ftitle" groupid="RentalContractsForm" argumentid="PassportNo"></div><span class="ftitle" groupid="RentalContractsForm" argumentid="PassportExpiry"></span>
                        ...
                        <td class="ftitle">
                            ...
                            <td>
                             <div style="float:left;width:135px" class="ftitle" groupid="RentalContractsForm" argumentid="NationalIDNo"></div><span class="ftitle" groupid="RentalContractsForm" argumentid="NationalIDExpiryDate"></span>
                            </td>
                        </tr>
                              <tr class="OnLoadHideCarCust">
                            <td class="ftitle">
                            ...
                            <td class="ftitle">
                                <span class="ftitle" groupid="RentalContractsForm" argumentid="InsuranceExpiry"></span><nobr style="padding-left:15px;"></nobr><span class="ftitle" groupid="RentalContractsForm" argumentid="FullInsuranceExpiry"></span>
                                
                                </td>
                         <td class="ftitle">
                                     <nobr>Driving License No.</nobr></td>
                            <td>
                               <div style="float:left;width:135px" class="ftitle" groupid="RentalContractsForm" argumentid="DrivingLicenseNo"></div><span class="ftitle" groupid="RentalContractsForm" argumentid="DrivingLicenseExpiry"></span></td>
                        </tr>
                              <tr class="OnLoadHideCarCust">
                            <td class="ftitle">
                     ...
                     <td class="ftitle">
                            ...
                            <td class="ftitle"> 
                                <span class="ftitle" groupid="RentalContractsForm" argumentid="WorkTelephone"></span><nobr class="CommaWR">, </nobr><span class="ftitle" groupid="RentalContractsForm" argumentid="ResidenceTelephone"></span></td>
                        </tr>
                              <tr>
                            <td class="ftitle">
                     ...
                     <td class="ftitle">
                            ...
                            <td class="ftitle">
                             <span class="ftitle" groupid="RentalContractsForm" argumentid="MobileTelephone1"></span><nobr class="CommaM12">, </nobr><span class="ftitle" groupid="RentalContractsForm" argumentid="MobileTelephone2"></span>
                             </td>
                        </tr>
                                 <tr>
                            <td colspan="4">
