<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RentalContracts_OC_FrUc.ascx.cs" Inherits="WebProject.Pages.eForms.iRental.RentalContracts_OC_FrUc" %>
                    ...
                    Use the form below to update the details, fields marked with an asterisk (*) are mandatory
                       ...
                       <tr>
                        ...
                        <tr>
                            ...
                            <td>
                      <input type="button" value="  Save  " class="DataAction ButtonStyle" conf="{ActorId:'DataHelper',ActionId:'DataAction',Command:'UPD_iRental_Contracts_OtherCharges',HideOnSuccess:true}">
